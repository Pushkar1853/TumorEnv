...
class ProliferationIMDecision(SubstepAction):
    """
        Action function for the proliferation substep
        Decide whether the immune cell proliferates or not prolifrating
        This function sends the neighborhood matrix to the transition function when proliferating
        or the original location matrix if the immune cell does not proliferate

        Steps:
            1. The action function receives input as the initial and new neighborhood of the immune cell
        ...
        Parameters:
            ...
            new_neighborhood (tensor): the new neighborhood of the immune cell
            initial_neighborhood (tensor): the initial location of the immune cell
    ...
    def forward(self, state, observation, tau=0.5):
        ...
        # print("immune cell proliferation action complete!")
